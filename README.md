...
[![Travis CI](https://travis-ci.org/greg-1-anderson/site-process.svg?branch=master)](https://travis-ci.org/greg-1-anderson/site-process)
[![Windows CI](https://ci.appveyor.com/api/projects/status/{{PUT_APPVEYOR_STATUS_BADGE_ID_HERE}}?svg=true)](https://ci.appveyor.com/project/greg-1-anderson/site-process)
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/greg-1-anderson/site-process/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/greg-1-anderson/site-process/?branch=master)
[![Coverage Status](https://coveralls.io/repos/github/greg-1-anderson/site-process/badge.svg?branch=master)](https://coveralls.io/github/greg-1-anderson/site-process?branch=master) 
...
[![License](https://poser.pugx.org/greg-1-anderson/site-process/license)](https://github.com/greg-1-anderson/site-process//master/LICENSE)
-->
...
| Feature                   | Setup
| ------------------------- | ----------------
| Collaborative repository  | [DONE](https://github.com/greg-1-anderson/site-process)
| Linux permutation testing | [DONE](https://travis-ci.org/greg-1-anderson/site-process)
...
deploy:
  ...
  on:
    tags: true
    repo: greg-1-anderson/site-process
```
...
- [GitHub issue templates](https://github.com/greg-1-anderson/site-process/issues/templates/edit)
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [releases](https://github.com/greg-1-anderson/site-process/releases) page.

## Authors

* **Greg Anderson** - created project from template.

See also the list of [contributors](https://github.com/greg-1-anderson/site-process/contributors) who participated in this project.
